...
public class Product extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -2605460888806411683L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Product\",\"namespace\":\"co.cp.orderly.kafka.model.avro\",\"fields\":[{\"name\":\"id\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"logicalType\":\"uuid\"},{\"name\":\"quantity\",\"type\":\"int\"}]}");
   ...
   */
  public static co.cp.orderly.kafka.model.avro.Product.Builder newBuilder() {
    return new co.cp.orderly.kafka.model.avro.Product.Builder();
  }
   ...
   * @return A new Product RecordBuilder
   */
  public static co.cp.orderly.kafka.model.avro.Product.Builder newBuilder(co.cp.orderly.kafka.model.avro.Product.Builder other) {
    if (other == null) {
      return new co.cp.orderly.kafka.model.avro.Product.Builder();
    } else {
      return new co.cp.orderly.kafka.model.avro.Product.Builder(other);
    }
  }
   ...
   * @return A new Product RecordBuilder
   */
  public static co.cp.orderly.kafka.model.avro.Product.Builder newBuilder(co.cp.orderly.kafka.model.avro.Product other) {
    if (other == null) {
      return new co.cp.orderly.kafka.model.avro.Product.Builder();
    } else {
      return new co.cp.orderly.kafka.model.avro.Product.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Product>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(co.cp.orderly.kafka.model.avro.Product.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(co.cp.orderly.kafka.model.avro.Product other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public co.cp.orderly.kafka.model.avro.Product.Builder setId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public co.cp.orderly.kafka.model.avro.Product.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public co.cp.orderly.kafka.model.avro.Product.Builder setQuantity(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public co.cp.orderly.kafka.model.avro.Product.Builder clearQuantity() {
