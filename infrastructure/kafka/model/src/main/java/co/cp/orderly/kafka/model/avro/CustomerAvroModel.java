...
public class CustomerAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 8683941051154591911L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"CustomerAvroModel\",\"namespace\":\"co.cp.orderly.kafka.model.avro\",\"fields\":[{\"name\":\"id\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"username\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"email\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"firstName\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"lastName\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
   ...
   */
  public CustomerAvroModel(java.lang.String id, java.lang.String username, java.lang.String email, java.lang.String firstName, java.lang.String lastName) {
    this.id = id;
   ...
   */
  public static co.cp.orderly.kafka.model.avro.CustomerAvroModel.Builder newBuilder() {
    return new co.cp.orderly.kafka.model.avro.CustomerAvroModel.Builder();
  }
   ...
   * @return A new CustomerAvroModel RecordBuilder
   */
  public static co.cp.orderly.kafka.model.avro.CustomerAvroModel.Builder newBuilder(co.cp.orderly.kafka.model.avro.CustomerAvroModel.Builder other) {
    if (other == null) {
      return new co.cp.orderly.kafka.model.avro.CustomerAvroModel.Builder();
    } else {
      return new co.cp.orderly.kafka.model.avro.CustomerAvroModel.Builder(other);
    }
  }
   ...
   * @return A new CustomerAvroModel RecordBuilder
   */
  public static co.cp.orderly.kafka.model.avro.CustomerAvroModel.Builder newBuilder(co.cp.orderly.kafka.model.avro.CustomerAvroModel other) {
    if (other == null) {
      return new co.cp.orderly.kafka.model.avro.CustomerAvroModel.Builder();
    } else {
      return new co.cp.orderly.kafka.model.avro.CustomerAvroModel.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CustomerAvroModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(co.cp.orderly.kafka.model.avro.CustomerAvroModel.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(co.cp.orderly.kafka.model.avro.CustomerAvroModel other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public co.cp.orderly.kafka.model.avro.CustomerAvroModel.Builder setId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public co.cp.orderly.kafka.model.avro.CustomerAvroModel.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public co.cp.orderly.kafka.model.avro.CustomerAvroModel.Builder setUsername(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public co.cp.orderly.kafka.model.avro.CustomerAvroModel.Builder clearUsername() {
      username = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public co.cp.orderly.kafka.model.avro.CustomerAvroModel.Builder setEmail(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public co.cp.orderly.kafka.model.avro.CustomerAvroModel.Builder clearEmail() {
      email = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public co.cp.orderly.kafka.model.avro.CustomerAvroModel.Builder setFirstName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public co.cp.orderly.kafka.model.avro.CustomerAvroModel.Builder clearFirstName() {
      firstName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public co.cp.orderly.kafka.model.avro.CustomerAvroModel.Builder setLastName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public co.cp.orderly.kafka.model.avro.CustomerAvroModel.Builder clearLastName() {
      lastName = null;
