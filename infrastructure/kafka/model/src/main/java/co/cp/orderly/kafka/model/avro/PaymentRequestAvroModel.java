...
public class PaymentRequestAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private co.cp.orderly.kafka.model.avro.PaymentOrderStatus paymentOrderStatus;
   ...
   */
  public PaymentRequestAvroModel(java.lang.String id, java.lang.String sagaId, java.lang.String customerId, java.lang.String orderId, java.math.BigDecimal price, java.time.Instant createdAt, co.cp.orderly.kafka.model.avro.PaymentOrderStatus paymentOrderStatus) {
    this.id = id;
    this.sagaId = sagaId;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 6: paymentOrderStatus = (co.cp.orderly.kafka.model.avro.PaymentOrderStatus)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public co.cp.orderly.kafka.model.avro.PaymentOrderStatus getPaymentOrderStatus() {
   ...
   * @param value the value to set.
   */
  public void setPaymentOrderStatus(co.cp.orderly.kafka.model.avro.PaymentOrderStatus value) {
   ...
   */
  public static co.cp.orderly.kafka.model.avro.PaymentRequestAvroModel.Builder newBuilder() {
    return new co.cp.orderly.kafka.model.avro.PaymentRequestAvroModel.Builder();
  }
   ...
   * @return A new PaymentRequestAvroModel RecordBuilder
   */
  public static co.cp.orderly.kafka.model.avro.PaymentRequestAvroModel.Builder newBuilder(co.cp.orderly.kafka.model.avro.PaymentRequestAvroModel.Builder other) {
    if (other == null) {
      return new co.cp.orderly.kafka.model.avro.PaymentRequestAvroModel.Builder();
    } else {
      return new co.cp.orderly.kafka.model.avro.PaymentRequestAvroModel.Builder(other);
    }
  }
   ...
   * @return A new PaymentRequestAvroModel RecordBuilder
   */
  public static co.cp.orderly.kafka.model.avro.PaymentRequestAvroModel.Builder newBuilder(co.cp.orderly.kafka.model.avro.PaymentRequestAvroModel other) {
    if (other == null) {
      return new co.cp.orderly.kafka.model.avro.PaymentRequestAvroModel.Builder();
    } else {
      return new co.cp.orderly.kafka.model.avro.PaymentRequestAvroModel.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PaymentRequestAvroModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(co.cp.orderly.kafka.model.avro.PaymentRequestAvroModel.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(co.cp.orderly.kafka.model.avro.PaymentRequestAvroModel other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public co.cp.orderly.kafka.model.avro.PaymentRequestAvroModel.Builder setId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public co.cp.orderly.kafka.model.avro.PaymentRequestAvroModel.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public co.cp.orderly.kafka.model.avro.PaymentRequestAvroModel.Builder setSagaId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public co.cp.orderly.kafka.model.avro.PaymentRequestAvroModel.Builder clearSagaId() {
      sagaId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public co.cp.orderly.kafka.model.avro.PaymentRequestAvroModel.Builder setCustomerId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public co.cp.orderly.kafka.model.avro.PaymentRequestAvroModel.Builder clearCustomerId() {
      customerId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public co.cp.orderly.kafka.model.avro.PaymentRequestAvroModel.Builder setOrderId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public co.cp.orderly.kafka.model.avro.PaymentRequestAvroModel.Builder clearOrderId() {
      orderId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public co.cp.orderly.kafka.model.avro.PaymentRequestAvroModel.Builder setPrice(java.math.BigDecimal value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public co.cp.orderly.kafka.model.avro.PaymentRequestAvroModel.Builder clearPrice() {
      price = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public co.cp.orderly.kafka.model.avro.PaymentRequestAvroModel.Builder setCreatedAt(java.time.Instant value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public co.cp.orderly.kafka.model.avro.PaymentRequestAvroModel.Builder clearCreatedAt() {
    ...
    /**
      ...
      * @return This builder.
      */
    public co.cp.orderly.kafka.model.avro.PaymentRequestAvroModel.Builder setPaymentOrderStatus(co.cp.orderly.kafka.model.avro.PaymentOrderStatus value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public co.cp.orderly.kafka.model.avro.PaymentRequestAvroModel.Builder clearPaymentOrderStatus() {
    ...
    public PaymentRequestAvroModel build() {
      try {
        ...
        record.paymentOrderStatus = fieldSetFlags()[6] ? this.paymentOrderStatus : (co.cp.orderly.kafka.model.avro.PaymentOrderStatus) defaultValue(fields()[6]);
        return record;
